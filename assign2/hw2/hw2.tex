...
\noindent{We knew that we would only need to modify the add and dispatcher functions since we are starting with the FIFO implementation. One of the sorts is already accomplished in the dispactcher and requests are merged as well.}
